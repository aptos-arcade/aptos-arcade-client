...
import {CharacterData, MeleeWeaponData, PlayerData, RangedWeaponData} from "@/types/PlayerData";
...
export const getPlayerData = (client: AptosClient, playerAddress: string): Promise<PlayerData> =>
    Promise.all([
